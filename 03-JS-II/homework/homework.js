...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  // tambien para resolverlo mas rapido se puede hacer return math.max (x,y);
  // esto hace que resuelva solo y busque el mayor componente
...
function conection(status) {
  ...
  // recordar que siempre lleva else + return 
